 ...
 * Cookies.vue
 * 
 * Página de Política de Cookies — LABANDA Industrie Services
 * Cumple RGPD y Directiva ePrivacy.
 * Colores corporativos: azul oscuro (#003366) y naranja (#FF6B35).
 * Uso de RouterLink para navegación interna sin recarga (SPA).
...
<template>
  <main class="min-h-screen bg-white text-gray-800">
    ...
    <section class="bg-[#003366] text-white py-16 px-6 text-center">
      ...
      <p class="text-blue-100 text-lg">Información sobre el uso de cookies en nuestro sitio web</p>
    </section>
    ...
    <section class="max-w-4xl mx-auto py-16 px-6 space-y-10 leading-relaxed">
      ...
      <section>
        ...
        <p>
          Las cookies son pequeños archivos de texto que los sitios web instalan en el dispositivo
          del usuario. Sirven para recordar preferencias, mejorar la experiencia de navegación y
      ...
      <section>
        ...
        <div class="space-y-6">
          ...
          <div class="border border-gray-200 rounded-lg p-6">
            ...
            <p>
              Facilitan una navegación personalizada recordando las preferencias del usuario
              (idioma, formato, región, etc.).
            </p>
            <ul class="list-disc pl-6 mt-2 text-sm space-y-1">
      ...
      <section>
        ...
        <p>
          Este sitio web puede utilizar servicios externos que instalen sus propias cookies, bajo
      ...
      <section>
        ...
        <p>
          Puede aceptar, rechazar o configurar el uso de cookies mediante el banner de configuración
          o a través de su navegador.
        </p>
      ...
      <div class="text-center pt-6">
        <RouterLink
          to="/legal/privacy"
          class="inline-flex items-center px-5 py-2 border border-[#003366] text-[#003366] rounded-md hover:bg-[#003366] hover:text-white transition-colors mr-3"
        >
          Ver Política de Privacidad
        </RouterLink>
        <RouterLink
          to="/"
          class="inline-flex items-center px-6 py-3 bg-[#003366] text-white rounded-lg hover:bg-[#FF6B35] transition-colors"
        >
          Volver al inicio
        </RouterLink>
      </div>
